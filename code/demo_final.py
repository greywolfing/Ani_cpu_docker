...
if __name__ == '__main__':
    ...
    parser.add_argument('--infer_type', type=str, default='hubert_audio_only', help='mfcc_pose_only or mfcc_full_control')
    parser.add_argument('--input_image', type=str, required=True, help='Path to the input image')
    parser.add_argument('--input_audio_text', type=str, required=True, help='Path to the input audio or text')
    parser.add_argument('--output_dir', type=str, required=True, help='Path to the output directory')
    parser.add_argument('--test_hubert_path', type=str, default='test_demos/audios_hubert/monalisa.npy', help='Path to the driven audio(hubert type). Not needed for MFCC')
    parser.add_argument('--stage1_checkpoint_path', type=str, default='ckpts/stage1.ckpt', help='Path to the checkpoint of Stage1')
    parser.add_argument('--stage2_checkpoint_path', type=str, default='ckpts/stage2_audio_only_hubert.ckpt', help='Path to the checkpoint of Stage2')
    ...
    args.test_image_path = args.input_image
    args.test_audio_path = args.input_audio_text
    args.result_path = args.output_dir
